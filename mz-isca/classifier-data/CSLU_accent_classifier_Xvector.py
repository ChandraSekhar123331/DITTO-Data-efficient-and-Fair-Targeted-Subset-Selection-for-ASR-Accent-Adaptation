...
class Wav2Vec2ForSpeechClassification(Wav2Vec2PreTrainedModel):
    def __init__(self, config):
        ...
        self.wav2vec2 = Wav2Vec2ForXVector(config)
...
#                param.requires_grad = False
    ...
    def freeze_base_model(self):
        for params in self.wav2vec2.parameters():
...
#        outputs = torch.nn.functional.normalize(outputs, dim=-1)
        ...
        h1, h2, logits = self.classifier(outputs)
...
training_args = TrainingArguments(
    output_dir="CSLU_training_data/checkpoints_Xvector",
