...
data_files = {
    "train": "data/with_all_1k/dristi_train.csv", 
    "validation": "data/with_all_1k/dristi_test.csv",
}
...
output_folder="data/dristi_accent-recognition_large",

training_args = TrainingArguments(
    output_dir="data/dristi_accent-recognition_large",
