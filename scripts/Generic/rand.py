...
from dataset import get_path, all_datasets, Dataset, BUDGET_TO_DURATION
import os
from finetune import finetune
from test import test
import numpy as np
import json
from utils import sample_greedy, read_lines, dump_lines
...
if __name__ == "__main__":
    ...
    config["FULL_PATH"] = os.path.join(
        config["HOME_PATH"], config["DATASET_PATH"], config["accent"]
    )
