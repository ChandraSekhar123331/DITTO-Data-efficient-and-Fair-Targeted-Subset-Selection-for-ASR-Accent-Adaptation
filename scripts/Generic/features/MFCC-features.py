...
def extract_features(file_list, feature_file):
...
def generate_features(config):
    ...
    FEATURE_DIR = os.path.join(config["FULL_DATASET_PATH"], SETTING_PATH, "features", "MFCC")
    ...
    extract_features(json_list, FEATURE_FILE)
