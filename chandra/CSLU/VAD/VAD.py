...
def main(args):
    ...
    parser.add_argument("--inp_wav_dir", type=str, required=True)
    parser.add_argument("--outp_wav_dir", type=str, required=True)
    ...
    for i, segment in enumerate(segments):
        path = f"{args['outp_wav_dir']}" + 'chunk-%002d.wav' % (i,)
