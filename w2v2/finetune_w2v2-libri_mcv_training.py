...
if fxn == 'random':
    trainp = f"../mz-isca/expts/{accent}/manifests/TSS_output/all/budget_200/target_20/random/run_1/train/train.csv"
elif fxn == 'classifier':
    trainp = f"../mz-isca/expts/{accent}/manifests/TSS_output/all/budget_200/classifier/run_1/train/train.csv"
elif fxn == 'cluster':
    trainp = f"../mz-isca/expts/{accent}/manifests/TSS_output/all/budget_200/cluster/run_1/train/train.csv"
elif fxn == 'seed':
    trainp = f"../mz-isca/expts/{accent}/manifests/seed.csv"
else:
    trainp = f"../mz-isca/expts/{accent}/manifests/TSS_output/all/budget_200/target_20/{fxn}/eta_1.0/euclidean/wv10_100/run_1/train/train.csv"
...
training_args = TrainingArguments(
  output_dir=f'mcv/{accent}/libri-100h/{fxn}',
