...
def compute_subset(dirs, base_dir, query_dir, ground_list, ground_features, ground_features_Y, query_list, query_features, private_features, test_features, greedyList, budget_size, target_size, accent, fxn, similarity, etaValue, feature_type):
    list_total_selection, list_total_count, list_total_duration = [], [], []
    list_accent_sample_count, list_accent_sample_duration = [], []
    output_dir = os.path.join(base_dir, query_dir, f'TSS_output/all/budget_{budget_size}/target_{target_size}/conditional_{fxn}_native/eta_{etaValue}/{similarity}/{feature_type}')
...
#    dirs = [f.name for f in os.scandir('/home/mayank/MTP/begin_again/Error-Driven-ASR-Personalization/CMU_expts/accent/') if f.is_dir()]
    ...
    return dirs, query_dir, ground_list, ground_features, ground_features_Y, ground_kernel, query_list, query_features, query_kernel, query_query_kernel, private_features, private_kernel, private_private_kernel, query_private_kernel, test_features 
...
dirs, query_dir, ground_list, ground_features, ground_features_Y, ground_kernel, query_list, query_features, query_kernel, query_query_kernel, private_features, private_kernel, private_private_kernel, query_private_kernel, test_features = preprocess(base_dir, target_size, budget_size, accent, similarity, feature_type)
...
compute_subset(dirs, base_dir, query_dir, ground_list, ground_features, ground_features_Y, query_list, query_features, private_features, test_features, greedyList, budget_size, target_size, accent, fxn, similarity, etaValue, feature_type)
