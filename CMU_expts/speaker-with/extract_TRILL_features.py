# creates feature TRILL files, currently set for CMU speakers
import numpy as np
import pickle
import json, os
...
base_dir = '/home/mayank/MTP/begin_again/Error-Driven-ASR-Personalization/CMU_expts/speaker_with/'
dirs = [f.name for f in os.scandir('.') if f.is_dir()]
if 'reserved_TSS_output' in dirs: 
