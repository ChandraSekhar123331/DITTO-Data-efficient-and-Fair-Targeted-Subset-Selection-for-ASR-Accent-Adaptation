...
def compute_subset(dirs, base_dir, ground_list, ground_features, ground_features_Y, test_features, greedyList, budget_size, target_size, speaker, fxn, similarity, feature_type):
...
dirs, query_dir, ground_list, ground_features, ground_features_Y, ground_kernel, test_features = preprocess(base_dir, target_size, budget_size, speaker, similarity, feature_type)
greedyList = generate_greedyList(ground_kernel, fxn, budget_size)
compute_subset(dirs, base_dir, ground_list, ground_features, ground_features_Y, test_features, greedyList, budget_size, target_size, speaker, fxn, similarity, feature_type)
