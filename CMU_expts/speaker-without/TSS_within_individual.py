...
def get_index(list_samples, indices):
    ...
    while total_duration + list_samples[indices[index]]['duration'] <= budget(budget_size):
...
#    print('__', dirs)
    ...
    for i in [1, 2, 3]:
        ...
        selection_file_path = base_dir + '../speaker_without/' + other_speaker + '/manifests/selection.json'
