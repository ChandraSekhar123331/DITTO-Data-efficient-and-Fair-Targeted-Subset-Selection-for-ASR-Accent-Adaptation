...
parser.add_argument("--target", type=int, help="target", required=True)
parser.add_argument("--eta", type=float, help="eta value", required=True)
parser.add_argument("--similarity", type=str, help="similarity metric", required=True)
parser.add_argument("--fxn", type=str, help="function", required=True)
parser.add_argument("--accent", type=str, help="query set", required=True)
parser.add_argument("--feature_type", type=str, help="which feature space", required=True)
