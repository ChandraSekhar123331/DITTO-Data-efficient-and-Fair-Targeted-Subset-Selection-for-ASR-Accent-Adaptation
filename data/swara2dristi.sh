for file in */m*/T*t/a*/*/*/*I/*/*/*/r*/t*/t*; do cp $file ${file/train./dristi_train.}; done
for file in */m*/T*t/w*/*/*/*/r*/t*/t*; do cp $file ${file/train./dristi_train.}; done
for file in */m*/T*t/a*/*/*/*/r*/t*/t*; do cp $file ${file/train./dristi_train.}; done
