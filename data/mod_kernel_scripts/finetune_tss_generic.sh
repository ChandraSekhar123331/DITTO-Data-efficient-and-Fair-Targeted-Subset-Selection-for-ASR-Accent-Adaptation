...
# declare -a accents=('hindi_male_english' 'assamese_female_english' 'rajasthani_male_english' 'tamil_male_english' 'gujarati_female_english' 'kannada_male_english' 'malayalam_male_english' 'manipuri_female_english')
