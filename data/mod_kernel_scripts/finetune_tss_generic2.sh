...
other_accent='rajasthani_male_english'
...
do
    ...
    do
        ...
        do 
            ...
            file_dir=$accent/all/seperate_GCMI/$other_accent/budget_$budget/target_$target/"$fxn"_etaScale_"$eta_scale"/accent_"$accent_feature_type"/content_"$content_feature_type"/kernel_g=accent_gq=accent_qq=accent/accent_"$accent_similarity"/content_"$content_similarity"/run_"$run"/
            mkdir -p $file_dir
            cp $accent/all/seperate_GCMI/$other_accent/budget_$budget/target_$target/"$fxn"_etaScale_"$eta_scale"/accent_"$accent_feature_type"/content_"$content_feature_type"/kernel_g=accent_gq=accent_qq=accent/accent_"$accent_similarity"/content_"$content_similarity"/train.json $file_dir
            cd "$finetunepath"
