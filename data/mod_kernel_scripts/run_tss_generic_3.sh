...
declare -a accents=('rajasthani_male_english' 'tamil_male_english' 'kannada_male_english' 'malayalam_male_english' 'gujarati_female_english' 'manipuri_female_english')
