...
# budget, target, features = 800, 10, '39'
# csv_name = "report_{}_{}_{}.csv".format(budget, target, features)
# sheet_csv="sheet_{}_{}_{}-indic.csv".format(budget, target, features)

ft, b1, b2, t = '39', 'full_budget', 250, 20
csv_name = "unfmted_rpt_{}_{}_{}_{}.csv".format(b1, t, ft, b2)
sheet_csv= "report_{}_{}_{}_{}.csv".format(b1, t, ft, b2)
